...
public class PriceMasterController {
	...
	PriceService priceservice;
	 ...
	 public Response addPrice(@Valid @RequestBody ChargingPointConnectorRateDto chargingPointConnectorRateDto)
		{
			return Response.created().setPayload(priceservice.addPrice(chargingPointConnectorRateDto));
