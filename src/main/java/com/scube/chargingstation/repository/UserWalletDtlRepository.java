...
public interface UserWalletDtlRepository extends JpaRepository<UserWalletDtlEntity, Long> {
	...
	@Query(value="select trhistory.amount as amount,DATE_FORMAT(trhistory.created_at, '%d %M %Y %r') as transactionDate, trhistory.transaction_type as transactionType,trhistory.remark"
