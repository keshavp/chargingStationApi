/*
 * package com.scube.chargingstation.config;
 * 
 ...
 * Docket(DocumentationType.SWAGGER_2) .select().build();
 * 
 * .apis(RequestHandlerSelectors.basePackage("com.scube.chargingstation"))
