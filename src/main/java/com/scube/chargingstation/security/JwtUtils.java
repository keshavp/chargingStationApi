 ...
 * 
 * import com.scube.chargingstation.service.UserDetailsImpl;
 * 
 ...
 * Jwts.parser().setSigningKey(SecurityConstants.SECRET).parseClaimsJws(
 * authToken); return true; } catch (SignatureException e) {
